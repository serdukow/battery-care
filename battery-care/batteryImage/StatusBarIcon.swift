...
internal struct StatusBarIcon {
    ...
    /// Draws a battery icon based   on the battery's current percentage during discharging.
    ///
    ...
    private func dischargingBatteryImage(forPercentage percentage: Double) -> NSImage? {
        ...
        // NSImage#drawThreePartImage glitches when the width of the capacity bar drops
